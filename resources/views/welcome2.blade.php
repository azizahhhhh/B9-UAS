...
<html lang="en" class="scroll-smooth">
  ...
  <body>
        ...
        <div class="relative -mx-4 flex items-center justify-between">
            <div class="w-60 max-w-full px-4">
                <a href="{{ url('/') }}" class="navbar-logo block w-full py-5 ">
                    <p class="font-bold text-xl text-white hover:bg-red-700">GETCO</p>
                </a>
            </div>
    ...
    <div
      id="home"
      class="relative overflow-hidden  pt-[120px] md:pt-[130px] lg:pt-[160px]" style="background-color: #6f4e37;"
    >
      <div class="container">
        <div class="-mx-4 flex flex-wrap items-center">
          <div class="w-full px-4">
            ...
            >
              ...
              >
                Sistem Manajemen Stock Bahan Baku Kelapa Berbasis Website <b><i>GETCO</i></b>
              </h1>
              <p
                class="mx-auto mb-10 max-w-[600px] text-base text-[#e4e4e4] sm:text-lg sm:leading-relaxed md:text-xl md:leading-relaxed"
              >
              Mempermudah pemilik usaha dalam melakukan pendataan stok bahan baku.
              </p>
            </div>
          </div>
    ...
    <section class="pt-15 pb-8 lg:pt-[120px] lg:pb-[70px]">
      <div class="container">
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4">
            <div class="mb-12 max-w-[620px] lg:mb-20">
              ...
              >
                Fitur utama yang ada dalam sistem
              </p>
            </div>
          </div>
        </div>
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4 md:w-1/2 lg:w-1/4">
            <div class="wow fadeInUp group mb-12 bg-white" data-wow-delay=".1s">
              ...
              <p class="mb-8 text-body-color lg:mb-11">
                Anda bisa melakukan menambahkan, mengubah dan melakukan rekap bahan baku
              </p>
            </div>
          </div>
          <div class="w-full px-4 md:w-1/2 lg:w-1/4">
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/4">
            <div class="wow fadeInUp group mb-12 bg-white" data-wow-delay=".2s">
              ...
              <h4 class="mb-3 text-xl font-bold text-dark">
                Perhitungan Kalkulator Produksi
              </h4>
              <p class="mb-8 text-body-color lg:mb-11">
                Melakukan perhitungan produksi berdasarkan bahan baku yang digunakan
              </p>
            </div>
          </div>
          <div class="w-full px-4 md:w-1/2 lg:w-1/4">
            ...
            >
              ...
              <p class="mb-8 text-body-color lg:mb-11">
                Untuk laporan rekap setiap supplier anda bisa melihatnya dalam bentuk grafik
              </p>
            </div>
          </div>
        </div>
    ...
    <!-- ====== Syarat Ketentuan Section Start -->
    <section id="testimonials" class="pt-15 md:pt-[120px]">
            ...
            <div class="mx-4 w-full">
              <div class="mx-auto mb-[60px] max-w-[620px] text-center lg:mb-20">
                ...
                <p
                  class="text-lg leading-relaxed text-body-color sm:text-xl sm:leading-relaxed"
                >
                Sebelum melakukan registrasi, harap membaca dengan cermat syarat dan ketentuan berikut:
                </p>
              </div>
            </div>
          </div>
    ...
    <!-- ====== Syarat Ketentuan Section End -->



    <!-- ====== Footer Section Start -->
    <footer
      class="wow fadeInUp relative z-10 bg-black lg:pt-[50px]"
      data-wow-delay=".15s"
    >
